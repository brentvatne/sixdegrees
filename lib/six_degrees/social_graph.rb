module SixDegrees
  ...
  class SocialGraph
    # The public API, which is also used internally to improve readability
    ...
    # Public: Initializes the SocialGraph
    #
    ...
    # Internal: Builds the first order of connections from a UserCollection
    ...
    # Internal: Builds connections from order 2 to up to depth.
    # First order connections must be built prior to calling this method for
    # it to work.
    ...
    # Internal: Builds the connections for a single specific order
    ...
    # Internal: Traverses nodes connected to the subject node and finds new
    # connections (order-1) must already be built in order for this to work
    # correctly.
    #
    ...
    # Internal: Operates on the edgeset to create an edge between two nodes, or
    # one node and a collecion of nodes
    #
    # params: :source - The String name of the source node
    #         :to     - The String name of the target node, or alternatively, an
    #                   Array of names
    #         :order  - The Integer order at which this connection will be
    #                   created
    #
    # No useful return value
    def connect(params)
